...
if (!empty($aCollections)) :
    ...
    elseif (isset($_GET['etat_suppression']) && true === (bool) $_GET['etat_suppression']) :
        echo '<div class="enregistrement">La suppression a été effectuée avec succès. token ok</div>';
    endif;
?>
<table>
    <thead>
...
<?php foreach ($aCollections as $aCollection) : ?>
        <tr>
            ...
            <td class="action">
                <a href="suppression_collection.php?id=<?php echo $aCollection['id']; ?>&jeton=<?php echo $_SESSION['token']; ?>">
                    supprimer
                </a>
            </td>
        </tr>
